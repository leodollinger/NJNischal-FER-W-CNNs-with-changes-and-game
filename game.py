...
class Game(tk.Frame):
    def __init__(self, master):
        ...
        self.canvas.bind('<Left>',
                         lambda _: self.paddle.move(-1*self.paddle.paddle_speed))
        self.canvas.bind('<Right>',
                         lambda _: self.paddle.move(self.paddle.paddle_speed))
    ...
    def add_ball(self):
        ...
        self.ball = Ball(self.canvas, x, 310 - self.paddle.height)
